/* empty css                                     */
import { b as createAstro, c as createComponent, a as renderTemplate, d as addAttribute, m as maybeRenderHead, u as unescapeHTML, e as renderScript, r as renderComponent } from '../chunks/astro/server_CcPgtZJR.mjs';
import 'kleur/colors';
...
}, "/home/gabogg_awewe/Code/PROYECTOS-ALIOSHA/pruebaspublicacionmeditec/src/layouts/components/impacto/CounterComponent.astro", void 0);
...
const $$Gallery = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="section"> <div class="container"> <div class="row justify-center text-center"> <div class="col-8"> <h2>${unescapeHTML(markdownify(title))}</h2> </div> </div> <div class="relative"> <div class="row" id="photo-gallery"> ${images.map((image) => renderTemplate`<div class="picture-item col-6 mt-12"> ${" "} <img class="w-full"${addAttribute(image, "src")} alt=""> </div>`)} <div class="js-shuffle-sizer col-1"></div> </div> <img class="absolute -bottom-5 -left-5 -z-[1]" src="images/shape-2.png" alt=""> <img class="absolute -right-5 bottom-20 -z-[1] h-16 w-16" src="images/shape.png" alt=""> </div> </div> </section> ${renderScript($$result, "/home/gabogg_awewe/Code/PROYECTOS-ALIOSHA/pruebaspublicacionmeditec/src/layouts/components/impacto/Gallery.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/gabogg_awewe/Code/PROYECTOS-ALIOSHA/pruebaspublicacionmeditec/src/layouts/components/impacto/Gallery.astro", void 0);
...
const $$Impacto = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": impacto.data.title, "meta_title": impacto.data.meta_title, "description": impacto.data.description, "image": impacto.data.image }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Shape", $$Shape, {})} ${maybeRenderHead()}<section class="page-hero py-16"> <div class="container -mt-14"> <div class="page-hero-content mx-auto max-w-[768px] text-center"> ${renderComponent($$result2, "PageHeader", $$PageHeader, { "page_data": page_data })} </div> ${renderComponent($$result2, "CounterComponent", $$CounterComponent, { "counter": counter })} <!-- benifit --> <!-- gellary --> ${renderComponent($$result2, "Gallery", $$Gallery, { "gallery": gallery })} <!-- our works --> <!-- <Works features={features} /> por si se quiere usar despues --> </div> </section> ` })}`;
}, "/home/gabogg_awewe/Code/PROYECTOS-ALIOSHA/pruebaspublicacionmeditec/src/pages/impacto.astro", void 0);

const $$file = "/home/gabogg_awewe/Code/PROYECTOS-ALIOSHA/pruebaspublicacionmeditec/src/pages/impacto.astro";
const $$url = "/impacto";

/* empty css                                     */
import { b as createAstro, c as createComponent, m as maybeRenderHead, u as unescapeHTML, r as renderComponent, d as addAttribute, a as renderTemplate } from '../chunks/astro/server_CcPgtZJR.mjs';
import 'kleur/colors';
...
}, "/home/gabogg_awewe/Code/PROYECTOS-ALIOSHA/pruebaspublicacionmeditec/src/layouts/components/Banner.astro", void 0);
...
}, "/home/gabogg_awewe/Code/PROYECTOS-ALIOSHA/pruebaspublicacionmeditec/src/layouts/components/Service.astro", void 0);

const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  const homepage = await getEntryBySlug("homepage", "index");
  const { banner, key_features, service, testimonial } = homepage.data;
  return renderTemplate`${renderComponent($$result, "Base", $$Base, {}, { "default": async ($$result2) => renderTemplate`  ${renderComponent($$result2, "Banner", $$Banner, { "banner": banner })}  ${renderComponent($$result2, "Service", $$Service, { "service": service })}  ` })}`;
}, "/home/gabogg_awewe/Code/PROYECTOS-ALIOSHA/pruebaspublicacionmeditec/src/pages/index.astro", void 0);

const $$file = "/home/gabogg_awewe/Code/PROYECTOS-ALIOSHA/pruebaspublicacionmeditec/src/pages/index.astro";
const $$url = "";

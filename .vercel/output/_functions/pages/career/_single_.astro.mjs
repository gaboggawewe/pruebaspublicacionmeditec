/* empty css                                        */
import { b as createAstro, c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, d as renderComponent } from '../../chunks/astro/server_RuF1lmQT.mjs';
import 'kleur/colors';
...
const $$single = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$single;
  const careerIndex = await getEntryBySlug("careers", "-index");
  const careers = await getSinglePage("careers");
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": post.data.title, "meta_title": post.data.meta_title, "description": post.data.description, "image": post.data.image }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Shape", $$Shape, {})} ${maybeRenderHead()}<section class="page-hero pb-14 pt-16"> <div class="container"> <div class="page-hero-content mx-auto max-w-[883px] text-center"> ${renderComponent($$result2, "PageHeader", $$PageHeader, { "page_data": page_data })} </div> </div> </section> <section class="section career-single pt-0"> <div class="container"> <div class="lg:gx-4 row"> <div class="lg:col-8"> <div class="content lg:py-[60px] rounded-xl bg-white p-7 shadow-lg lg:px-12"> ${renderComponent($$result2, "Content", Content, {})} </div> </div> ${renderComponent($$result2, "CareerSidebar", $$CareerSidebar, { "posts": similarPosts[0], "sidebar_content": careerIndex.data.sidebar_content })} </div> </div> </section> ` })}`;
}, "C:/Users/gabog/OneDrive/TEC/TEC/carrera/tercer semestre/PAGINA MEDITEC/Meditec/src/pages/career/[single].astro", void 0);

const $$file = "C:/Users/gabog/OneDrive/TEC/TEC/carrera/tercer semestre/PAGINA MEDITEC/Meditec/src/pages/career/[single].astro";

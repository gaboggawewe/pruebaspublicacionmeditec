/* empty css                                        */
import { b as createAstro, c as createComponent, m as maybeRenderHead, r as renderComponent, d as addAttribute, a as renderTemplate } from '../../chunks/astro/server_CcPgtZJR.mjs';
import 'kleur/colors';
import { c as config, h as humanize, s as slugify, $ as $$Base } from '../../chunks/Base_BO0XG6xc.mjs';
...
const Disqus = () => {
  const { disqus } = config;
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "row mt-16 justify-center ", children: /* @__PURE__ */ jsx(
    DiscussionEmbed,
    {
...
}, "/home/gabogg_awewe/Code/PROYECTOS-ALIOSHA/pruebaspublicacionmeditec/src/pages/blog/[single].astro", void 0);

const $$file = "/home/gabogg_awewe/Code/PROYECTOS-ALIOSHA/pruebaspublicacionmeditec/src/pages/blog/[single].astro";
